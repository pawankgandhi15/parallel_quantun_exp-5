...
\begin{enumerate}
    ...
    \item \textbf{Zero-Noise Extrapolation (ZNE):} Under high gate error rates, expectation values can be extrapolated to the zero-noise limit by pulse stretching or unitary folding \cite{temme2017error, cai2025quantum}.
